...
class DanIntMembership(models.Model):
    ...
    dojo = models.CharField(_("Dojo"), choices=constants.DOJO_CHOICES, max_length=100)
    ...
    accept_terms = models.BooleanField(_("Accept Terms"), default=False, blank=False)
    liability_disclaimer = models.BooleanField(_("Liability Disclaimer"), default=False, blank=False)
